...
The performance of the baseline Transformer model on the IWSLT 14 DE-EN translation task is **34.20** bleu score and our Xformer's performance is **29.68** bleu score while achieving substantial acceleration.
